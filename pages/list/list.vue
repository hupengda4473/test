<template>
	<view>
		<view class="" v-show="!loadShow">
			...
			<view class="" :style="{marginTop: 'calc('+menuButtonInfo.top+'px + 12% + 45rpx + 30rpx)'}"></view>
			<view class="u-skeleton">

				<view class="" style="height: 60rpx;" v-if="modelType!='search' && modelType!='tags'"></view>
				<view class="">
						...
						<block v-for="(item, index) in coverList" :key="index">
							<block v-for="(item_, index_) in item.images" :key="index_">
								...
								<view class="tab u-skeleton-fillet" @click="detail(item._id, index_, item.images)">
									<image :src="vuex_compressPicture?item_+'?x-oss-process=image/resize,w_600/quality,q_80':item_" style="width: 220rpx;height: 400rpx;" mode="aspectFill"></image>
								</view>
							</block>
